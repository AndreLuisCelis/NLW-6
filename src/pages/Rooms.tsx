...
export function Rooms() {
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        if (!user) {
            throw new Error('è preciso estar logado para fazer uma pergunta');
        }
        const question = {
            content: newQuestion,
            author: {
        ...
        <div id="page-room">
            ...
            <header>
                <div className="content">
                    <img src={imgLogo} alt="" onClick={goToAdminRoom} />
                            ...
                            return (
                                <Question
                                    ...
                                    {!question.isAnswered && (
                                        ...
                                        type='button'
                                        aria-label=' button para dar like'
...
function useRooms(): { questions: any; title: any; } {
